    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Web Penjualan Sepatu</a>
        </div>
        ...
        <!-- Wrapper for Slides -->
          <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/bar2.png');"></div>
                <div class="carousel-caption">
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="row col-md-12">
				<hr>
				<img src="<?php echo $url.'assets/img/me.png'; ?>" width="100%"><br><br>
			</div>
		</div>